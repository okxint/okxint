...
🛠️ **[Product Teardown](https://pm-teardown.vercel.app)** — Enter any product name, get a 5,000-word PM-grade analysis with user journey mapping, drop-off analysis, and prioritized solutions. Scrapes 8+ sources in parallel.
